  ...
  <footer class="pt-16 pb-8 border-t dark:border-gray-600  sm:mb-0">
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-10 gap-10">
      <div class="col-span-1 md:col-span-4">
        ...
        <p class="my-4 block sm:w-10/12 text-slate-500">
          I’m <span class="font-semibold text-blue-500">Pramudita Ahmad</span>, a Full Stack Web Developer, I code just
          for fun & i love it
        </p>
        <SocialMedia />
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            ...
            <ul class="mt-4 text-slate-500">
              ...
              <li>
                <NuxtLink to="/me/">About Me</NuxtLink>
              </li>
              <li>
          ...
          <div>
            ...
            <p class="text-sm mt-4 text-slate-500">
              if you need me for business you can send ur email.
            </p>
            <form @submit.prevent="addEmail" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
              class="validate" target="_blank" novalidate>

              <input id="email" class="mt-3 form-control" type="email" name="EMAIL" v-model="email"
                placeholder="Enter your email" />

              <div style="position: absolute; left: -5000px" aria-hidden="true">

                <input type="text" name="b_2df9d9dee856197c9cb3e0fac_ac2908ee1e" tabindex="-1" value="" />
              </div>
              <button class="btn w-full btn-primary mt-3">send</button>
            </form>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="text-slate-700">
        &copy; 2023. Who cares ? It's
        <a href="https://github.com/jouskapram/pramudita" target="_blank" rel="nofollow"
